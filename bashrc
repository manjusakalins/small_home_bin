...
alias mtknew_fl_cur_code='cd ~/mytools/in_bitbucker_cur_code_output_fl/; sudo ./flash_tool'
alias batpull='sh ~/bin/battery_pull.sh'
alias batls='adb shell ls -l /sdcard/DCIM/'
alias batcat='sh ~/bin/battery_cat.sh'
#export JAVA_HOME=/usr/lib/jvm/java-1.7.0-openjdk-amd64/
#alias jmkc='./makeJlink -a "make copy" -p '
#alias jmk='. ~/bin/jmk_init_project.sh'
source ~/perl5/perlbrew/etc/bashrc
unset GREP_OPTIONS
alias jbuild='cd /home/manjusaka/all_codes/new_my_code/in_bitbucket/jenkens_py; python t4_main.py;'
